...
sysName = 'DualMoving' #System Name here
...
#    This Double Moving Average System currently utilizes two moving averages
#    shortand longer term
#    buy MOC when short crosses above long
#    sell MOC when short crosses below longe
#    exit long MOC when close is $3000 below entry 
#    exit short MOC when close is $3000 above entry
#--------------------------------------------------------------------------------
 #Long Entry Logic
